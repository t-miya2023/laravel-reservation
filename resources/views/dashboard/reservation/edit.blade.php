...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-10 d-flex flex-column">
            ...
            @endif
            <form method="POST" action="{{ route('dashboard.reservation.editshowroom',$reservation->id) }}" enctype='multipart/form-data'>
                @csrf
                <div class="row">
                    ...
                    <div class="mb-3 col-12 col-sm-6">
                        ...
                        <input class="form-control" type="time" name="checkin_time" step="1800" min="15:00" max="24:00" value="{{ $reservation->checkin_time }}">
                        @error('checkin_time')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <a class="btn btn-warning mx-5" href="{{ route('dashboard.reservation.index') }}">戻る</a>
            </form>
            <div class="mt-5 text-end">
            @include('dashboard.reservation.delete')
